...
public class CameraMove : MonoBehaviour
{
    ...
    const string datasetImagesPath = "D:/toyDataset_test_air";
    ...
    void Awake()
    {
        ...
        groupIndicies = File.ReadAllLines("Assets/Resources/person_models/groupSplits/toyDatatset_test.txt").ToList();
    }
